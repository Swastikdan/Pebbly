import type { WatchlistData, WatchItemSummary } from "./recommendations";
...
export function appendFeedbackSignals(prompt: string, feedback?: FeedbackSignals): string {
  let result = prompt;
...
export function buildWatchlistPrompt(
  ...
  const listItemsByListId = new Map<string, any[]>();
