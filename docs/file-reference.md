...
| `ai.ts`                     | `callGeminiAI`, Workers AI client using JSON mode and `@cf/meta/llama-3.1-8b-instruct-fast`; optional local Gemini fallback; per-element Valibot validation and retries.                                                                                                                                                                                                    |
