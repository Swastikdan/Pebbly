...
| `fns/recommendations.ts`    | AI generation, homepage picks, history, feedback, rate limiting (`helpers/rate-limit.ts` ledger). Picks-list writes live in `services/picks-list.ts`.                                                                                                                                                                                                                        |
