...
export const SECTION_TAB_LIST_CLASS =
	"h-8 rounded-full bg-transparent ring-1 ring-border px-0.5 ";
export const SECTION_TAB_TRIGGER_CLASS =
	"h-7 px-3.5 text-xs font-semibold rounded-full data-[state=active]:bg-secondary data-[state=active]:shadow-none dark:data-[state=active]:border-transparent dark:data-[state=active]:bg-secondary dark:data-[state=active]:shadow-none";
