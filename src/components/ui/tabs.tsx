      ...
      <TabsPrimitive.Indicator
        className={cn(
          ...
          variant === "underline"
            ...
            : "bg-background dark:bg-input -z-1 h-[var(--active-tab-height)] w-[var(--active-tab-width)] [translate:var(--active-tab-left)_var(--active-tab-top)] rounded-sm shadow-none",
        )}
