...
export function InputGroup({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: coss ui library component — keeps the generic div + role="group" contract
		<div
			className={cn(
...
export function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: coss ui library component — mousedown forwards focus to the grouped input
		<div
