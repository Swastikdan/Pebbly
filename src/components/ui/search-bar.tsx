			...
			>
				<div className="relative w-full">
					...
					<Input
						...
						autoFocus={autoFocus}
						className={cn(
							"peer h-11 w-full rounded-xl bg-card/95 ps-11 pr-11 text-[16px] md:text-[15px] border border-border transition-[color,background-color,border-color,box-shadow] duration-150 placeholder:text-muted-foreground/70 focus:bg-card focus:border-ring/40 focus:ring-2 focus:ring-ring/15 dark:bg-input/35 dark:focus:bg-background shadow-none px-0",
