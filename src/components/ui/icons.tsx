...
export interface IconSvgProps extends React.ComponentProps<"svg"> {
	size?: string | number;
	className?: string;
}
...
export const Logo: React.FC<IconSvgProps> = ({ ...props }) => (
	...
	>
		...
		<defs>
			{/* biome-ignore lint/correctness/useUniqueElementIds: static SVG gradient IDs are referenced by URL */}
			<linearGradient
...
export const SpinIcon = ({ ...props }: IconSvgProps) => (
	<svg
		height={props.size ?? 24}
		width={props.size ?? 24}
		className={props.className}
...
export const MoreHorizontal = ({ ...props }: IconSvgProps) => (
	<svg
		height={props.size ?? 24}
		width={props.size ?? 24}
		className={props.className}
