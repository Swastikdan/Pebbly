...
type DailyPickState = ReturnType<typeof useDailyPick>;

function DailyPickDialogContent({
  children,
}: {
  children: (pick: DailyPickState) => React.ReactElement;
}) {
  const pick = useDailyPick(true);
              ...
              pick.isDataLoading ? (
                ...
                <div className="flex min-h-62.5 flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-muted-foreground mt-1 max-w-xs text-xs">
                    All available recommendations have already been watched or
                    marked as disliked.
                  </p>
                </div>
              )
