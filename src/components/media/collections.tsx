      ...
      {isLoading ? (
        ...
        <div className="bg-secondary relative h-48 w-full overflow-hidden rounded-2xl md:h-52 lg:h-60">
          ...
          <div className="relative flex h-full flex-col items-start justify-center p-5">
            <span className="text-background dark:text-foreground font-heading text-lg font-bold md:text-xl lg:text-2xl xl:text-3xl">
            ...
            >
              <Button
                className="pressable mt-3 font-medium shadow"
                size="lg"
                variant="secondary"
              >
                View Collection
