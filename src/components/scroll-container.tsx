	...
	return (
		<div className={cn("relative w-full overflow-hidden", className)}>
			{isControlsEnabled && canScrollLeft && (
				<>
					...
					<Button
						...
						className="absolute left-2 top-1/2 z-20 hidden size-9 -translate-y-1/2 transform items-center justify-center rounded-lg shadow-md backdrop-blur-sm transition-[color,background-color,box-shadow,transform] duration-200 hover:scale-105 sm:flex"
						variant="light"
						size="icon"
						onClick={scrollLeft}
						tabIndex={0}
			...
			<section
				...
				className="scrollbar-hidden relative w-full overflow-x-auto rounded-md scroll-snap-x sm:scroll-smooth"
			>
			...
			{isControlsEnabled && canScrollRight && (
				<>
					...
					<Button
						...
						className="absolute right-2 top-1/2 z-20 hidden size-9 -translate-y-1/2 transform items-center justify-center rounded-lg shadow-md backdrop-blur-sm transition-[color,background-color,transform,box-shadow] duration-200 hover:scale-105 sm:flex"
						variant="light"
						size="icon"
						onClick={scrollRight}
						tabIndex={0}
