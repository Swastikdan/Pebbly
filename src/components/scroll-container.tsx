			...
			{isControlsEnabled && canScrollLeft && (
				<>
					...
					<Button
						...
						className="absolute left-2 top-1/2 z-20 hidden size-9 -translate-y-1/2 transform items-center justify-center rounded-lg shadow-md backdrop-blur-sm transition-[color,background-color,transform] duration-200 hover:scale-105 sm:flex"
						variant="light"
						size="icon"
						onClick={scrollLeft}
						tabIndex={0}
			...
			{isControlsEnabled && canScrollRight && (
				<>
					...
					<Button
						...
						className="absolute right-2 top-1/2 z-20 hidden size-9 -translate-y-1/2 transform items-center justify-center rounded-lg shadow-md backdrop-blur-sm transition-[color,background-color,transform] duration-200 hover:scale-105 sm:flex"
						variant="light"
						size="icon"
						onClick={scrollRight}
						tabIndex={0}
