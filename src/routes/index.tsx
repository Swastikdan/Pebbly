...
const ContinueWatching = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.ContinueWatching })));
const PopularMovies = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.PopularMovies })));
const PopularTv = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.PopularTv })));
const TopRatedMovies = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.TopRatedMovies })));
const TopRatedTv = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.TopRatedTv })));
const UpcomingMovies = lazy(() => import("@/components/homepage-media").then(m => ({ default: m.UpcomingMovies })));
