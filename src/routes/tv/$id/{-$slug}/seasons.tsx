          ...
          >
            <div className="border-default bg-secondary/10 hover:border-foreground/20 hover:bg-secondary/20 hover: flex items-start gap-5 rounded-3xl border-2 p-3 transition-[color,background-color,border-color,box-shadow] duration-150 md:p-5">
              ...
              <div className="flex flex-1 flex-col items-start justify-center gap-2 overflow-hidden py-3">
                <div className="font-heading line-clamp-1 text-xl font-bold transition-opacity duration-200 ease-in-out hover:opacity-90 md:text-2xl dark:hover:opacity-70">
                  {season.name}
                </div>
                <div className="flex flex-wrap items-center gap-2">
                  {season.vote_average > 0 && (
                    <Badge
                      className="w-min rounded-lg px-3 text-sm font-light"
                      variant="secondary"
                    >
